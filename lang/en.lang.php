<?php
     ...
     * @brief  Upgletyle(upgletyle) module's English language pack.
     **/
    ...
    $lang->about_upgletyle = 'Upgletyle is a blog module running on XpressEngine.';
    $lang->msg_requried_version = "Upgletyle requires XE core version equal to or greater than %s.";

	$lang->cmd_open_id = 'Open ID Login';
	$lang->cmd_common_id = 'Default Login';
	$lang->msg_create_upgletyle = 'Upgletyle is created';
	$lang->init_category_title = 'Default Category';
	$lang->add_category = 'Add a category';
    $lang->upgletyle_admin = 'Upgletyle administrator';
    $lang->upgletyle_title = 'Upgletyle\'s title';
    ...
    $lang->upgletyle_summary = 'Summary of Upgletyle';
    $lang->item_unit = ' ';
    ...
    $lang->blog_description = 'One-line Description';
    ...
    $lang->about_addon = 'Addons are to control Upgletyle\'s actions. Turning on/off addons would add useful features to your sites.';
    $lang->addon_using = 'Using';
    $lang->lang_time_zone = 'Language/Time zone';
    $lang->language = 'Language';
    $lang->timezone = 'Time Zone';
    $lang->edit_style = 'Editor';
    $lang->upgletyle_editor = 'Paragraph Editor';
    ...
    $lang->about_upgletyle_editor = 'Upgletyle\'s default editor: You can edit each paragraph separately in your posts';
    ...
    $lang->about_suffix = 'Each post contains following content. (You can useHTML)';
    $lang->blog_first_page = 'First Page';
    $lang->blog_display_target = 'Display target';
    ...
    $lang->guestbook_editor = 'Guestbook editor';
    $lang->comment_list_count = 'Number of comments per page';
    $lang->guestbook_list_count = 'Number of guestbook posts per page';
    $lang->comment_grant = 'Permission for writing comments';
    $lang->about_comment_grant = 'You may allow only members or all to write comments';
    ...
    $lang->guestbook_grant = 'Permission for writing to guestbook';
    ...
    $lang->upgletyle_password1 = 'New Password';
    $lang->upgletyle_password2 = 'Confirm new password';
    ...
    $lang->manage_guestbook ='Guestbook';
    $lang->manage_comment ='Comments';
    ...
    $lang->recent_tags = 'Recently used tags';
    ...
    $lang->data_export = 'Data Backup';
    $lang->data_import = 'Data Migration (Import)';
    $lang->migration_prepare = 'Analyzing files';
    $lang->data_import_progress = 'Import progress rate';
    $lang->data_export_progress = 'Export progress rate';
    $lang->about_export_xexml = 'You can import data with XE XML format used in XpressEngine';
    $lang->about_export_ttxml = 'You can import data with TTXML format used in Textcube (or Tistory)';
    ...
    $lang->about_blog_api = 'Using BlogAPI, you can publish/ modify/ delete posts to other blogs or bulletin boards <BR /> Currently, Upgletyle only supports MetaWebLog API, but other APIs will be supported soon.<br/>Using BlogAPI might be restricted accoring to the configuration of the server Upgletyle installed in.';
    ...
    $lang->about_blogapi_service = 'Please select API Service for remote blogging.<br/>You can use Custom if there is no service available.';
    $lang->blogapi_hosted = 'Service Blog';
    $lang->blogapi_custom = 'Custom';
    $lang->blogapi_host_provider = 'Service Blog Provider';
    $lang->about_blogapi_host_provider = 'Please select provider of service blog';
    $lang->blogapi_type = 'API Type';
    $lang->about_blogapi_type = 'You need to fill in API Type';
	...
	$lang->cmd_upgletyle_blogapi_service = 'Blog API Service';
	...
	$lang->password_description = 'API Password Type';
    $lang->target_site_url = 'Site URL';
    $lang->blogapi_site_url = 'Target Site';
    ...
    $lang->about_blogapi_url = 'Please input BlogAPI URL. (in case of service blog, modify [id] or domain)';
    $lang->blogapi_published = 'Number of Published Posts';
    $lang->blogapi_user_id = 'UserID';
    $lang->about_blogapi_user_id = 'Input user ID used in target site of API';
    $lang->blogapi_password = 'Password';
    $lang->about_blogapi_password = 'Input password used in target site of API';
    $lang->cmd_get_site_info = 'Get Site Info.';
    $lang->cmd_check_api_connect = 'Check API connection';
    $lang->msg_url_is_invalid = "Cannot access to the URL\n\nCheck if URL is correct ";
    $lang->msg_remove_api = 'Are you sure to delete API Information?';
    $lang->msg_blogapi_registration = array(
        'Input target site\'s address',
        'Input target site\'s title',
        'Input API URL',
        'Input ID',
        'Input password',
    );

    $lang->about_use_bookmarklet = 'How to Use Bookmarklet';
    ...
    $lang->document_reserved = 'View Temporarily Saved';

    $lang->my_document_management = 'My Post management';
    $lang->set_publish = 'Publish Configuration';
    $lang->document_open = 'Open';
    ...
    $lang->about_upgletyle_admin = 'You can enter more admins by just sepparating them with a comma (,).';
    $lang->insert_title = 'Input title';
    $lang->new_post = 'Write a Post';
    $lang->modify_post = 'Modify a post';
    $lang->posting_option = 'Posting Options';
    $lang->post_url = 'Url for the post';
    $lang->about_tag = 'Multiple tags are separated by comma(,)';
    ...
    $lang->upgletyle_first_menus = array(
        array('dispUpgletyleToolDashboard','Dashboard'),
        array('','My Posts'),
        array('','My Pages'),
        array('','Communication'),
        array('','Statistics'),
    ...
    $lang->upgletyle_second_menus = array(
        array(),
        array(
            'dispUpgletyleToolPostManageWrite'=>'Write',
            'dispUpgletyleToolPostManageList'=>'Posts',
            'dispUpgletyleToolPostManageDeposit'=>'Writing Ingredients',
            'dispUpgletyleToolPostManageCategory'=>'Category',
            'dispUpgletyleToolPostManageTag'=>'Tags',
            'dispUpgletyleToolPostManageBasket'=>'Recycle Bin',
        ),
        array(
        	'dispUpgletyleToolExtraMenuInsert'=>'New Text Page',
        	'dispUpgletyleToolExtraMenuModuleInsert'=>'New Module Page',
        	'dispUpgletyleToolExtraMenuList'=>'All Pages',
        ),
        array(
            'dispUpgletyleToolCommunicationComment'=>'Comments',
            'dispUpgletyleToolCommunicationGuestbook'=>'Guestbook',
            'dispUpgletyleToolCommunicationTrackback'=>'Trackbacks',
            'dispUpgletyleToolCommunicationSpam'=>'Spam Filter',
        ),
        array(
            'dispUpgletyleToolStatisticsVisitor'=>'Visitor',
            'dispUpgletyleToolStatisticsVisitRoute'=>'Referer',
            'dispUpgletyleToolStatisticsSupporter'=>'Supporter',
            'dispUpgletyleToolStatisticsPopular'=>'Popular Contents',
        ),
        array(
            'dispUpgletyleToolLayoutConfigSkin'=>'Skins',
            'dispUpgletyleToolLayoutConfigEdit'=>'HTML&middot;CSS Edit',
            'dispUpgletyleToolLayoutConfigMobileSkin'=>'Mobile Skins',
        ),
        array(
            'dispUpgletyleToolConfigProfile'=>'My Profile',
            'dispUpgletyleToolConfigInfo'=>'Blog Configuration',
            'dispUpgletyleToolConfigPostwrite'=>'Writing Env.',
            'dispUpgletyleToolConfigEditorComponents'=>'Editor Components',
            'dispUpgletyleToolConfigCommunication'=>'Publish&middot;Comm.',
            'dispUpgletyleToolConfigBlogApi'=>'Remote Blogging',
            'dispUpgletyleToolConfigAddon'=>'Addons',
            'dispUpgletyleToolConfigData'=>'Data',
            'dispUpgletyleToolConfigChangePassword'=>'Change Password',
        ),
    );

    $lang->cmd_go_help = 'Help Desk';
    $lang->cmd_upgletyle_setup = 'Default Settings';
    $lang->cmd_upgletyle_list = 'Upgletyle List';
    $lang->cmd_upgletyle_creation = 'Create a new Upgletyle';
    $lang->cmd_upgletyle_modify = 'Edit upgletyle';
    $lang->cmd_upgletyle_custom_menu = 'Upgletyle Menu Customize';
    ...
    $lang->category_result = 'Category';
    $lang->newest_document = 'Recent Posts';
    ...
    $lang->sample_title = 'Welcome to Upgletyle world!';
    $lang->sample_tags = 'Upgletyle, Upgletyle Editor, Writing Ingredients Collector';
    $lang->msg_preparation = 'In preparation';
    $lang->msg_not_user = 'No one matches.';
    $lang->success_upgletyle_init = 'Resetting upgletyle is completed';
	$lang->upgletyle_init = 'Reset';
    $lang->cmd_upgletyle_init = 'Reset Upgletyle';
    $lang->msg_upgletyle_init_about = 'Reset all information including postings, comments, trackbacks, guestbook and layout information. It is impossible to recover the data after resetting your Upgletyle.';
    $lang->msg_confirm_upgletyle_init = 'Are you sure to reset?';

	$lang->upgletyle_skin_userimage = 'User Image';
	$lang->msg_check_userimage = 'You may upload gif, png, jpg, swf file.';
    $lang->cmd_upgletyle_skin_export = 'Backup skin';
    $lang->upgletyle_skin_import = 'Restore skin';
    $lang->about_upgletyle_skin_import = 'It uploads customized skin from local folder, and current skin will be removed.';

	$lang->success_upload = 'It is successfully uploaded.';
	$lang->cmd_upgletyle_export_request ='Backup Requests';
	$lang->upgletyle_export_recode = 'Backup Requests';
	$lang->upgletyle_export_waiting = 'Waiting';
	$lang->upgletyle_export_request = 'Request backup';
	$lang->upgletyle_export_type = 'Backup Data type';
	$lang->upgletyle_export_date = 'Backup Date';
	$lang->upgletyle_export_file = 'Data File';
	$lang->cmd_upgletyle_export_file = 'Backup';
    ...
    $lang->about_textyle_extra_menu = 'You may add modules from XpressEngine as menuitems to your Upgletyle.';
    $lang->cmd_textyle_extra_menu_config = 'Additional Menu';
    $lang->cmd_upgletyle_new_page = 'New Text Page';
    $lang->cdm_upgletyle_new_module_page = 'New Module Page';
    $lang->textyle_extra_menu_limit_count = 'Maximum Number';
	$lang->msg_limit_upgletyle_extra_mid = 'Only format of alphabets + [alphabets, numbers, and underscore(_)] is allowed.';
	...
	$lang->upgletyle_bug_report = 'report for bugs';
