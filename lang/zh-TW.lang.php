<?php
     ...
     * @brief  部落格 (Upgletyle) 模組正體中文語言
     **/

    $lang->upgletyle = 'Upgletyle';
    $lang->about_upgletyle = 'Upgletyle是運作於 XpressEngine 的部落格模組。';
    $lang->msg_requried_version = "Upgletyle需要 XE Core %s 以上的版本。";

	$lang->cmd_open_id = 'OpenID 登入';
	$lang->cmd_common_id = '一般登入';
	$lang->msg_create_upgletyle = '已建立 Upgletyle';
	$lang->init_category_title = '預設分類';
	$lang->add_category = '新增分類';
    $lang->upgletyle_admin = 'Upgletyle 管理員(ID)';
    $lang->upgletyle_title = 'Upgletyle 標題';
    ...
    $lang->about_upgletyle_editor = 'Upgletyle 預設編輯器：可分別編輯文章段落';
	...
	$lang->cmd_upgletyle_blogapi_service = 'Blog API 服務設定';
    ...
    $lang->upgletyle_password1 = '新密碼';
    $lang->upgletyle_password2 = '確認新密碼';
    ...
    $lang->upgletyle_first_menus = array(
        array('dispUpgletyleToolDashboard','管理首頁'),
        array('','文章管理'),
        array('','交流管理'),
        array('','統計管理'),
        array('','介面管理'),
    ...
    $lang->upgletyle_second_menus = array(
        array(),
        array(
            'dispUpgletyleToolPostManageWrite'=>'發表文章',
            'dispUpgletyleToolPostManageList'=>'文章列表',
            'dispUpgletyleToolPostManageDeposit'=>'素材管理',
            'dispUpgletyleToolPostManageCategory'=>'分類管理',
            'dispUpgletyleToolPostManageTag'=>'標籤管理',
            'dispUpgletyleToolPostManageBasket'=>'垃圾桶',
        ),
        array(
            'dispUpgletyleToolCommunicationComment'=>'迴響管理',
            'dispUpgletyleToolCommunicationGuestbook'=>'留言管理',
            'dispUpgletyleToolCommunicationTrackback'=>'引用管理',
            'dispUpgletyleToolCommunicationSpam'=>'過濾管理',
        ),
        array(
            'dispUpgletyleToolStatisticsVisitor'=>'訪問統計',
            'dispUpgletyleToolStatisticsVisitRoute'=>'訪問路徑',
            'dispUpgletyleToolStatisticsSupporter'=>'粉絲',
            'dispUpgletyleToolStatisticsPopular'=>'熱門主題',
        ),
        array(
            'dispUpgletyleToolLayoutConfigSkin'=>'面板選擇',
            'dispUpgletyleToolLayoutConfigEdit'=>'HTML&middot;CSS 編輯',
            'dispUpgletyleToolLayoutConfigMobileSkin'=>'모바일스킨선택',
        ),
        array(
            'dispUpgletyleToolConfigProfile'=>'個人檔案',
            'dispUpgletyleToolConfigInfo'=>'部落格設定',
            'dispUpgletyleToolConfigPostwrite'=>'發表設定',
            'dispUpgletyleToolConfigEditorComponents'=>'編輯器元件',
            'dispUpgletyleToolConfigCommunication'=>'公開&middot設定',
            'dispUpgletyleToolConfigBlogApi'=>'遠端發佈',
            'dispUpgletyleToolConfigAddon'=>'附加元件管理',
            'dispUpgletyleToolConfigData'=>'資料管理',
            'dispUpgletyleToolConfigChangePassword'=>'變更密碼',
            'dispUpgletyleToolExtraMenuList'=>'附加選單',
        ),
    );

    $lang->cmd_go_help = '使用說明';
    $lang->cmd_upgletyle_setup = '基本設定';
    $lang->cmd_upgletyle_list = 'Upgletyle 列表';
    $lang->cmd_upgletyle_creation = '建立 Upgletyle';
    $lang->cmd_upgletyle_custom_menu = '自訂 Upgletyle 選單';
    ...
    $lang->msg_select_skin = '所選擇面板將套用到 Upgletyle 部落格。\n\n此操作將刪除正在使用的面板資料。\n\n確定要變換面板嗎?';
    ...
    $lang->sample_title = '歡迎來到 Upgletyle 的世界!';
    $lang->sample_tags = 'upgletyle,  Upgletyle 編輯器,  素材蒐集器';
    $lang->msg_preparation = '準備中';
    $lang->msg_not_user = '用戶不存在';
    $lang->success_upgletyle_init = '重置成功';
	$lang->upgletyle_init = '重置';
    $lang->cmd_upgletyle_init = '開始重置';
    $lang->msg_upgletyle_init_about = '所有文章/迴響/引用/留言板/版面將會被刪除與重置。重置後將無法復原。';
    $lang->msg_confirm_upgletyle_init = '確定要重置嗎?';

	$lang->upgletyle_skin_userimage = '用戶相片';
	$lang->msg_check_userimage = '允許上傳 gif, png, jpg, swf 等檔案。';
    $lang->cmd_upgletyle_skin_export = '匯出';
    $lang->upgletyle_skin_import = '匯入面板';
    $lang->about_upgletyle_skin_import = '上傳客製化面板。 目前的面板會被刪除。';

	$lang->success_upload = '上傳成功';
	$lang->cmd_upgletyle_export_request ='備份記錄';
	$lang->upgletyle_export_recode = '備份記錄';
	$lang->upgletyle_export_waiting = '審查中';
	$lang->upgletyle_export_request = '備份記錄';
	$lang->upgletyle_export_type = '匯出類型';
	$lang->upgletyle_export_date = '檔案建立時間';
	$lang->upgletyle_export_file = '資料檔案';
	$lang->cmd_upgletyle_export_file = '匯出檔案';
