...
function loadPage(document_srl, page) {
	...
	exec_xml("upgletyle", "getUpgletyleCommentPage", params, completeGetPage, ['html','error','message'], params);
}
...
function deleteGuestbookItem(srl){
    ...
    exec_xml('upgletyle', 'procUpgletyleGuestbookItemDelete', params, function(){
		location.reload();	
	}, response_tags);
...
function deleteCommentItem(srl){
    ...
    exec_xml('upgletyle', 'procUpgletyleCommentItemDelete', params, function(){
		location.reload();	
	}, response_tags);
...
function checkPasswordForDeleteComment(f){
    ...
    exec_xml('upgletyle', 'procUpgletyleDeleteComment', params, function(){
		if(f.callback_url.value) location.href = f.callback_url.value;
	}, response_tags);
